...
import { Text, KeyboardAvoidingView, StyleSheet, TouchableOpacity, TextInput, Image, ScrollView } from 'react-native'
        ...
        return (
            <ScrollView style={styles.container}>
                <TouchableOpacity style={styles.selectButton} onPress={() => { this.handleSelectImage() }}>
                    <Text style={styles.selectButtonText}>Escolher imagem</Text>
                </TouchableOpacity>
